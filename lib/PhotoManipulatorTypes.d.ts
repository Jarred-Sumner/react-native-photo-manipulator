...
export declare type ImageSource = string | number;
...
export declare type PhotoBatchOperations = PhotoBatchPrintText | PhotoBatchOverlay;
export interface PhotoManipulatorStatic {
     ...
     * @param quality (optional) Quality of result image in `0 - 100`
     */
    batchWithTransparentImage: (imageSize: Size, operations: PhotoBatchOperations[], cropRegion: Rect, targetSize?: Size, quality?: number, mimeType?: MimeType) => Promise<string>;
    /**
     ...
     */
    optimize: (image: ImageSource, quality: number, mimeType?: MimeType) => Promise<string>;
}
export {};
